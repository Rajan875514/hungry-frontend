...
// import toast from "react-hot-toast";
// import { login } from "../../Redux/Slices/authSlice.js";
//  import LoginImage3 from "../../Assets/login3.jpeg"; // You can use this if needed, but I'll go with the other one for consistency
...
//   const handleInputChange = (e) => { // Corrected function name for consistency
//     const { name, value } = e.target;
//     setLoginData({ ...loginData, [name]: value });
//   };

//   const onLogin = async (e) => { // Corrected function name
//     e.preventDefault();
...
//       style={{
//         backgroundImage:`url(${LoginImage3})`,
//       }}
//     >
...
//           >
//             Log In <BsArrowRight className="ml-2 w-5 h-5" />
//           </button>
//         </form>
     ...
     >
       <div className="w-full max-w-md backdrop-blur-md bg-white/30 rounded-xl shadow-lg p-6">
         ...
         <form onSubmit={onLogin}>
          ...
          {/* Google Login Button */}
          <button
             className="mt-4 w-full bg-white text-blue-800 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-100 transition duration-300 flex items-center justify-center"
             onClick={() => {
